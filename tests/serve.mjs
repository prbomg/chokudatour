...
const server = http.createServer((req,res) => {
  queue = queue.then(async () => {
    ...
    if (['/assets/homepage.js','/assets/homepage-actions.js','/assets/homepage-base.css','/assets/homepage-workspace.css','/assets/event-workspace.css','/assets/event-workspace.js','/assets/client-workspace.css','/assets/client-workspace.js','/assets/schedule-workspace.css','/assets/tours-workspace.css','/assets/tour-builder-workspace.css','/assets/analytics-workspace.css','/assets/settings-workspace.css','/assets/style.css','/assets/app.js'].includes(url.pathname)) {
