...
php.mkdir('/app');
const allowed = ['index.php','event.php','client.php','clients.php','schedule.php','tours.php','tour_builder.php','participants.php','analytics.php','widget.php'];
...
const server = http.createServer((req,res) => {
  queue = queue.then(async () => {
    ...
    if (['/assets/homepage.js','/assets/homepage-actions.js','/assets/homepage-base.css','/assets/homepage-workspace.css','/assets/event-workspace.css','/assets/event-workspace.js','/assets/client-workspace.css','/assets/client-workspace.js','/assets/schedule-workspace.css','/assets/tours-workspace.css','/assets/tour-builder-workspace.css','/assets/analytics-workspace.css','/assets/style.css','/assets/app.js'].includes(url.pathname)) {
