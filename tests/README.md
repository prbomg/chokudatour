...
Workspace UI verification additionally covers modal departure editing, quick participant creation with recalculated seats and income, the departure side panel, removing one active filter, expanding notes, repeating a departure without its date or bookings, and the same actions on dynamically loaded history rows. The side panel and modal forms were checked at 320/390 px without page overflow.
