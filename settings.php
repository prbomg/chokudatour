...
<head>
    ...
    <style>
        ...
        .export-card{display:grid;grid-template-columns:42px minmax(0,1fr) auto;align-items:center;gap:12px;min-width:0;margin:0;padding:15px;border:1px solid var(--border);border-radius:13px;background:#fff}.backup-icon,.database-icon{display:inline-flex;align-items:center;justify-content:center;width:42px;height:42px;border-radius:11px;background:var(--primary-light);color:var(--primary)}
        .backup-icon svg,.database-icon svg{display:block;width:20px!important;height:20px!important;max-width:20px!important;max-height:20px!important;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.export-card>div{display:grid;gap:3px;min-width:0}.export-card strong{font-size:14px}.export-card div span{color:var(--text-muted);font-size:10px;line-height:1.35}
    ...
    <section class="backup-section section-wrap" aria-labelledby="backup-title">
        ...
        <div class="backup-body">
            <div class="export-grid">
                <form method="post" action="backup.php" class="export-card"><?= formTokenInput() ?><input type="hidden" name="backup_action" value="clients"><span class="backup-icon"><svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg></span><div><strong>Клиенты</strong><span>Контакты, поездки, суммы, теги и заметки</span></div><button type="submit">CSV <b>↓</b></button></form>
                <form method="post" action="backup.php" class="export-card"><?= formTokenInput() ?><input type="hidden" name="backup_action" value="events"><span class="backup-icon"><svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="4" width="18" height="17" rx="2"/><path d="M8 2v4M16 2v4M3 10h18"/></svg></span><div><strong>Выезды</strong><span>Расписание, гиды, места, доходы и расходы</span></div><button type="submit">CSV <b>↓</b></button></form>
                <form method="post" action="backup.php" class="export-card"><?= formTokenInput() ?><input type="hidden" name="backup_action" value="payments"><span class="backup-icon"><svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true"><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20M6 15h2"/></svg></span><div><strong>Платежи</strong><span>Оплаты и возвраты с привязкой к туристам</span></div><button type="submit">CSV <b>↓</b></button></form>
                <form method="post" action="backup.php" class="export-card"><?= formTokenInput() ?><input type="hidden" name="backup_action" value="receipts"><span class="backup-icon"><svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 2h11l5 5v15H4zM14 2v6h6M8 13h8M8 17h6"/></svg></span><div><strong>Архив чеков</strong><span>ZIP с файлами и реестром расходов</span></div><button type="submit">ZIP <b>↓</b></button></form>
            </div>
            <form method="post" action="backup.php" class="database-backup" onsubmit="return confirm('Создать полную резервную копию базы? Сохраните скачанный файл в надёжном месте.')"><?= formTokenInput() ?><input type="hidden" name="backup_action" value="database"><span class="database-icon"><svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true"><ellipse cx="12" cy="5" rx="8" ry="3"/><path d="M4 5v6c0 1.7 3.6 3 8 3s8-1.3 8-3V5M4 11v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6"/></svg></span><div><span class="backup-kicker">Полное сохранение</span><strong>Резервная копия базы</strong><p>Все выезды, туристы, платежи, настройки и структура сервиса в одном SQL-файле.</p></div><button type="submit">Создать и скачать копию <b>↓</b></button><small>Храните файл в защищённом месте</small></form>
        </div>
    </section>
