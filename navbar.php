...
<nav class="navbar">
    ...
    <a href="<?= isset($orders_url) ? htmlspecialchars($orders_url, ENT_QUOTES) : (isset($return_url) ? htmlspecialchars($return_url, ENT_QUOTES) : 'index.php') ?>" class="nav-link <?= is_active(['index.php', 'event.php']) ?>">
    ...
    <?php if (isset($current_user_role) && $current_user_role === 'admin'): ?>
        ...
        <a href="history.php" class="nav-link <?= is_active(['history.php']) ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 3-6.7L3 8"></path><path d="M3 3v5h5"></path><path d="M12 7v5l3 2"></path></svg>
            История
        </a>
